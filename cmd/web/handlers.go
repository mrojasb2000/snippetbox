...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	// Check that the title value is not blank and is not more the 100
	...
	if strings.TrimSpace(form.Content) == "" {
		form.FieldErrors["content"] = "This field must cannot be blank"
	}
	...
	// field. Note that weuse the HTTP status code 422 Unprocessable Entity
